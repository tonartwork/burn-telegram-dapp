...
export function CarouselCylindrical({ images }: CarouselCylindricalProps) {
  ...
  const autoRotateSpeed = 0.2; // Speed of auto-rotation (adjust as needed)
    ...
    <>
      <div className="relative h-[500px] w-full overflow-hidden">
        <div
          ...
          style={{
            background:
              "linear-gradient(to left, rgba(255, 255, 255, 0) 0%, rgb(255, 255, 255) 100%)",
          }}
        />
        <div
        ...
        />
        <div
          className="flex items-center justify-center h-full bg-mauve-dark-2"
          style={{
            perspective: "1000px",
          ...
          >
            {images.map((imgUrl, i) => {
              return (
                <div
                  key={i}
                  className="absolute flex items-center justify-center h-full p-2 origin-center bg-mauve-dark-2"
                  style={{
                    width: `${faceWidth}px`,
                    transform: `rotateY(${
                      i * (360 / faceCount)
