...
export interface EnvVariables {
  ...
  NEXT_PUBLIC_JETTON_ADDRESS: string
...
export const env = {
  ...
  NEXT_PUBLIC_BURN_CONTRACT_ADDRESS: process.env.NEXT_PUBLIC_BURN_CONTRACT_ADDRESS || process.env.NEXT_PUBLIC_COLLECTION_ADDRESS || '',
